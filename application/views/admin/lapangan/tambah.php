<form action="<?php echo base_url('admin/tambah_lapangan_act')?>" method="post">
...
<div class="col-md-12">
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-9">
                <input autofocus type="text" name="kd_lapangan" id="kd_lapangan" class="form-control kd_lapangan">
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-9">
                <input type="text" name="nama_lap" id="nama_lap" class="form-control nama_lap">
            </div>
        </div>
    </div>
